...
class Assignment5Test extends \Codeception\Test\Unit
{
    ...
    public function testOneYearlyDistance()
    {
        ...
        $this->assertNotEquals(2015, $skier->affiliations[0]->season);
        $this->assertEquals(2016, $skier->affiliations[1]->season);
        $this->assertEquals(202, $skier->affiliations[1]->distance);
    ...
    public function testTwoYearlyDistances()
    {
        ...
        $this->assertGreaterThan(0, $skier->affiliations[0]->distance);
        $this->assertGreaterThan(0, $skier->affiliations[1]->distance);
        $this->assertEquals(23, $skier->affiliations[0]->distance);
        $this->assertEquals(55, $skier->affiliations[1]->distance);
